...
sevplot <- ggplot(filter(climate, condition =="Control" | condition == "Severity"), aes(condition, cc_int, colour = condition, fill = condition)) + 
...
susplot <- ggplot(filter(climate, condition =="Control" | condition == "Susceptibility"), aes(condition, cc_int, colour = condition, fill = condition)) + 
  #geom_flat_violin(position = position_nudge(x = .2, y = 0), adjust = 2)+
...
mrrplot <- ggplot(filter(climate, condition =="Control" | condition == "MRR"), aes(condition, cc_int, colour = condition, fill = condition)) + 
  #geom_flat_violin(position = position_nudge(x = .2, y = 0), adjust = 2)+
...
replot <- ggplot(filter(climate, condition =="Control" | condition == "Response Efficacy"), aes(condition, cc_int, colour = condition, fill = condition)) + 
  #geom_flat_violin(position = position_nudge(x = .2, y = 0), adjust = 2)+
...
rcplot <- ggplot(filter(climate, condition =="Control" | condition == "Response Costs"), aes(condition, cc_int, colour = condition, fill = condition)) + 
  #geom_flat_violin(position = position_nudge(x = .2, y = 0), adjust = 2)+
