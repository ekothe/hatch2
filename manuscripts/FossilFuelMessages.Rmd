...
apa_table(coi_tidy, caption = "Impact of interventions on target construct relative to control", placement = "htb", col.names = c("Comparisions", "Construct", "Control Mean", "Control SD", "Control n", "Intervention Mean", "Intervention SD", "Intervention n",  "\\textit{t}", "\\textit{p}"), align = "llcccccccc", small = TRUE, landscape = TRUE)
```
